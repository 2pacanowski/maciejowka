...
const translations = {
  en: {
    ...
    'location.lead':    'Willa Maciejówka sits on ul. Sienkiewicza 18 — a peaceful, tree-lined residential street right in the centre of Zakopane. The famous Krupówki promenade and the Gubałówka funicular are just a short walk away, while the neighbourhood itself stays wonderfully quiet.',
    'loc.d1': 'Krupówki Promenade',              'loc.t1': '5 min walk',
    'loc.d2': 'Gubałówka Funicular Station',      'loc.t2': '10 min walk',
    'loc.d3': 'Zakopane Train Station',           'loc.t3': '15 min walk',
    'loc.d4': 'Termy Zakopane Thermal Baths',     'loc.t4': '8 min drive',
    'loc.d5': 'Polana Szymoszkowa Ski Resort',    'loc.t5': '10 min drive',
    'loc.d6': 'Kasprowy Wierch Cable Car',        'loc.t6': '15 min drive',
    'loc.d7': 'Dolina Kościeliska Trailhead',     'loc.t7': '20 min drive',
    'loc.d8': 'Morskie Oko Trailhead',            'loc.t8': '25 min drive',
    'loc.d9': 'Kraków Airport (KRK)',             'loc.t9': '1 h 45 min drive',
  ...
  pl: {
    ...
    'location.lead':    'Willa Maciejówka stoi przy ul. Sienkiewicza 18 — spokojnej, zadrzewionej ulicy mieszkalnej w samym centrum Zakopanego. Słynna promenada Krupówki i kolejka na Gubałówkę są w zasięgu krótkiego spaceru, a sama ulica pozostaje przyjemnie cicha.',
    'loc.d1': 'Promenada Krupówki',              'loc.t1': '5 min pieszo',
    'loc.d2': 'Stacja kolejki na Gubałówkę',     'loc.t2': '10 min pieszo',
    'loc.d3': 'Dworzec PKP Zakopane',            'loc.t3': '15 min pieszo',
    'loc.d4': 'Termy Zakopane',                  'loc.t4': '8 min samochodem',
    'loc.d5': 'Stacja narciarska Polana Szymoszkowa', 'loc.t5': '10 min samochodem',
    'loc.d6': 'Kolejka na Kasprowy Wierch',      'loc.t6': '15 min samochodem',
    'loc.d7': 'Szlak do Doliny Kościeliskiej',   'loc.t7': '20 min samochodem',
    'loc.d8': 'Szlak na Morskie Oko',            'loc.t8': '25 min samochodem',
    'loc.d9': 'Lotnisko Kraków (KRK)',           'loc.t9': '1 godz. 45 min samochodem',
