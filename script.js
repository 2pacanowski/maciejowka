...
const translations = {
  en: {
    ...
    'hero.eyebrow':  'ul. Sienkiewicza 18 · Zakopane · Tatra Mountains',
    'hero.subtitle': 'A century-old Góral landmark in the heart of Zakopane — steps from Krupówki, in a peaceful residential street. Perfect for families and groups of friends. Dogs welcome.',
    ...
    'about.body1':   'The ground floor opens into a double-height living room with traditional folk-art details. A fully-equipped large kitchen leads into a sunny conservatory with a generous dining table — the heart of every family gathering. Outside, a private garden offers a quiet retreat just moments from Zakopane\'s vibrant centre.',
    'about.body2':   'Upstairs, four bedrooms — each with large double beds, quality linens and thoughtful folk-art details — sleep up to nine guests in comfort. Three full bathrooms ensure nobody has to queue. Ideal for families with children and groups of friends — dogs are warmly welcome.',
